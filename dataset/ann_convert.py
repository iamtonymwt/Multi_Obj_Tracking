    ...
    for frame_id, obj in enumerate(objLists):
        if len(obj) > 0:
            ...
            for id, pos, occl in zip(obj['id'][0], obj['pos'][0], obj['occl'][0]):
                ...
                annos[frame_name]["reID"].append(id)
            if not annos[frame_name]["bbox"]:
                del annos[frame_name]
    # print(annos)
    # 'set04_V011_1866.jpg': ({'id': 'set04_V011_1866.jpg', 'label': 'person', 'occlusion': [0], 'bbox': [[578.6333333333333, 173.65555555555557, 28.712454212454304, 60.54603174603176]], 'reID': [4]})
    return annos
...
def main():
    vbb_inputdir = "./dataset/caltech/annotations"
    vbb_outputdir = "./dataset/caltech/annotations_voc"
